...
__global__ void kernel_2(){
	...
	if( !( 1<=i ) || !( i<=(2799-1) ) )return;
	int thread_count_1 = (2799-1)-1+1;
...
__global__ void kernel_4(){
	...
	if( !( 1<=p ) || !( p<=(2799-1) ) )return;
	int thread_count_3 = (2799-1)-1+1;
