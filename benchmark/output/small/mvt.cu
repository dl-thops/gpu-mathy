...
__device__ float x1[122];
__device__ float x2[122];
__device__ float y_1[122];
__device__ float y_2[122];
...
int main(){
	...
	float* h_x1 = (float*) malloc(sizeof(float)* (122));
	cudaMemcpyFromSymbol(h_x1,x1,sizeof(float)* (122));
	float* h_x2 = (float*) malloc(sizeof(float)* (122));
	cudaMemcpyFromSymbol(h_x2,x2,sizeof(float)* (122));
	float* h_y_1 = (float*) malloc(sizeof(float)* (122));
	cudaMemcpyFromSymbol(h_y_1,y_1,sizeof(float)* (122));
	float* h_y_2 = (float*) malloc(sizeof(float)* (122));
	cudaMemcpyFromSymbol(h_y_2,y_2,sizeof(float)* (122));
	gettimeofday(&t2, 0);
