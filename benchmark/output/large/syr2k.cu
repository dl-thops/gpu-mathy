...
__device__ float A[1202][1002];
__device__ float B[1202][1002];
__device__ float C[1202][1202];
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_A = (float*) malloc(sizeof(float)* (1202)* (1002));
	cudaMemcpyFromSymbol(h_A,A,sizeof(float)* (1202)* (1002));
	float* h_B = (float*) malloc(sizeof(float)* (1202)* (1002));
	cudaMemcpyFromSymbol(h_B,B,sizeof(float)* (1202)* (1002));
	float* h_C = (float*) malloc(sizeof(float)* (1202)* (1202));
	cudaMemcpyFromSymbol(h_C,C,sizeof(float)* (1202)* (1202));
	gettimeofday(&t2, 0);
