...
__device__ float x1[2002];
__device__ float x2[2002];
__device__ float y_1[2002];
__device__ float y_2[2002];
...
int main(){
	...
	float* h_x1 = (float*) malloc(sizeof(float)* (2002));
	cudaMemcpyFromSymbol(h_x1,x1,sizeof(float)* (2002));
	float* h_x2 = (float*) malloc(sizeof(float)* (2002));
	cudaMemcpyFromSymbol(h_x2,x2,sizeof(float)* (2002));
	float* h_y_1 = (float*) malloc(sizeof(float)* (2002));
	cudaMemcpyFromSymbol(h_y_1,y_1,sizeof(float)* (2002));
	float* h_y_2 = (float*) malloc(sizeof(float)* (2002));
	cudaMemcpyFromSymbol(h_y_2,y_2,sizeof(float)* (2002));
	gettimeofday(&t2, 0);
