...
__device__ float A[7002][7002];
__device__ float B[7002][8002];
__device__ float C[7002][8002];
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_A = (float*) malloc(sizeof(float)* (7002)* (7002));
	cudaMemcpyFromSymbol(h_A,A,sizeof(float)* (7002)* (7002));
	float* h_B = (float*) malloc(sizeof(float)* (7002)* (8002));
	cudaMemcpyFromSymbol(h_B,B,sizeof(float)* (7002)* (8002));
	float* h_C = (float*) malloc(sizeof(float)* (7002)* (8002));
	cudaMemcpyFromSymbol(h_C,C,sizeof(float)* (7002)* (8002));
	gettimeofday(&t2, 0);
