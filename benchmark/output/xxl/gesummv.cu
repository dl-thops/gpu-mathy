...
__device__ float A[10002][10002];
__device__ float B[10002][10002];
__device__ float tmp[10002];
__device__ float x[10002];
__device__ float y[10002];
...
__global__ void main_kernel(){
	...
	alpha = 1.5;
	beta = 1.2;
	int thread_count_2 = (10000-1)-0+1;
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_A = (float*) malloc(sizeof(float)* (10002)* (10002));
	cudaMemcpyFromSymbol(h_A,A,sizeof(float)* (10002)* (10002));
	float* h_B = (float*) malloc(sizeof(float)* (10002)* (10002));
	cudaMemcpyFromSymbol(h_B,B,sizeof(float)* (10002)* (10002));
	float* h_tmp = (float*) malloc(sizeof(float)* (10002));
	cudaMemcpyFromSymbol(h_tmp,tmp,sizeof(float)* (10002));
	float* h_x = (float*) malloc(sizeof(float)* (10002));
	cudaMemcpyFromSymbol(h_x,x,sizeof(float)* (10002));
	float* h_y = (float*) malloc(sizeof(float)* (10002));
	cudaMemcpyFromSymbol(h_y,y,sizeof(float)* (10002));
	gettimeofday(&t2, 0);
