...
__device__ float A[8002][7002];
__device__ float B[8002][7002];
__device__ float C[8002][8002];
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_A = (float*) malloc(sizeof(float)* (8002)* (7002));
	cudaMemcpyFromSymbol(h_A,A,sizeof(float)* (8002)* (7002));
	float* h_B = (float*) malloc(sizeof(float)* (8002)* (7002));
	cudaMemcpyFromSymbol(h_B,B,sizeof(float)* (8002)* (7002));
	float* h_C = (float*) malloc(sizeof(float)* (8002)* (8002));
	cudaMemcpyFromSymbol(h_C,C,sizeof(float)* (8002)* (8002));
	gettimeofday(&t2, 0);
