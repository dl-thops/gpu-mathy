...
__global__ void kernel_3(){
	...
	int thread_count_1 = (12000-1)-1+1;
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_A = (float*) malloc(sizeof(float)* (12003));
	cudaMemcpyFromSymbol(h_A,A,sizeof(float)* (12003));
