...
__device__ float L[20002][20002];
__device__ float b[20002];
__device__ float x[20002];
...
int main(){
	...
	main_kernel<<<1,1>>>();
	cudaDeviceSynchronize();
	float* h_L = (float*) malloc(sizeof(float)* (20002)* (20002));
	cudaMemcpyFromSymbol(h_L,L,sizeof(float)* (20002)* (20002));
	float* h_b = (float*) malloc(sizeof(float)* (20002));
	cudaMemcpyFromSymbol(h_b,b,sizeof(float)* (20002));
	float* h_x = (float*) malloc(sizeof(float)* (20002));
	cudaMemcpyFromSymbol(h_x,x,sizeof(float)* (20002));
	gettimeofday(&t2, 0);
