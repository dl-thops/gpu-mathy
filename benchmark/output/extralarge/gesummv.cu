...
__device__ float B[15002][15002];
__device__ float tmp[15002];
...
int main(){
	...
	float* h_B = (float*) malloc(sizeof(float)* (15002)* (15002));
	cudaMemcpyFromSymbol(h_B,B,sizeof(float)* (15002)* (15002));
	float* h_tmp = (float*) malloc(sizeof(float)* (15002));
	cudaMemcpyFromSymbol(h_tmp,tmp,sizeof(float)* (15002));
